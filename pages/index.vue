  ...
  <main>
    ...
    <section class="instructions">
      ...
      <div>
        ...
        <p>
          Cuando le pongas reiniciar, se guardará el precio anterior y aparecerá
          en el fondo de la casilla, y si le pones reiniciar sin escribir ningún
          precio, se borrarán los precios anteriores.
        </p>
    ...
    <details>
      ...
      <small
        >En realidad son dos toques, mira uno es para abrir un cuadro de diálogo
        y el otro es para confirmar, pero estás de acuerdo que si no confirmamos
        podríamos tener algunos errores, ¿verdad? entonces pues digamos que es
        un solo toque, el de confirmación.</small
      >
    </details>
  </main>
</template>
