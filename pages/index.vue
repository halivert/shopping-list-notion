    ...
    <main>
      <div>
        <section class="hero">
          ...
          <p class="tagline">
            Hola, aquí podrás utilizar tu lista de compras como una calculadora
            y también almacenar los precios anteriores con un solo toque*
          </p>
        ...
        <section class="instructions">
          ...
          <div>
            ...
            <a href="https://notion.so">Notion</a> con una lista de tareas
            (To-do List)
            ...
            Después puedes seleccionarla cuando te pregunte por que páginas
            deseas elegir.

            <p>
              <img
                src="/img/select-page.webp"
                alt="Seleccionar página deseada"
              />
            </p>

            Así tendrás la lista de tareas con una casilla a un lado donde
            podrás escribir el precio que te costó.
        ...
        <p>
          <small>
            Puedes leer la
            <NuxtLink :to="{ name: 'policy' }">política de privacidad</NuxtLink>
            y también los
